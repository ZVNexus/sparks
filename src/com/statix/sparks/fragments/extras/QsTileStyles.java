...
public class QsTileStyles extends InstrumentedDialogFragment implements OnClickListener {
    ...
    private void initView() {
        LinearLayout framed = mView.findViewById(R.id.QsTileStyleFramed);
        setLayout("1", framed);
    ...
    public void onClick(DialogInterface dialog, int which) {
        ...
        if (which == AlertDialog.BUTTON_NEUTRAL) {
            Settings.System.putIntForUser(resolver,
                    Settings.System.QS_SELECTOR, 0, mCurrentUserId);
            dismiss();
        }
    }
        ...
        if (layout != null) {
            layout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Settings.System.putIntForUser(resolver,
                            Settings.System.QS_SELECTOR, Integer.parseInt(style), mCurrentUserId);
                    dismiss();
                }
            });
        }
